...
from routers import checklist_package
            ...
            try:
                ...
                if src_count == 0:
                    default_sources = [
                        ...
                        ("tam_at", "TAM — Österreich", "tam", "AUT",
                         "https://webgate.ec.europa.eu/competition/transparency/public",
                         "Phase-1-Slice: Beihilfen mit Granting-Authority Österreich (alle 9 Bundesländer).", "yellow"),
                        ...
                        ("national_ro", "Rumänien — REGAS", "national", "ROU",
...
app.include_router(checklist_package.router)
