...
PARTS = [
    ("Vermeidung von Doppelfinanzierung", [
        ("1", "Art. 11 CPR",
         ...
         ["Partnerschaftsvereinbarung (Abschnitt 2)", "Aufrufe zur Einreichung von Vorschlägen", "Fördervereinbarungen (für die Vorhaben in der Stichprobe)"],
        ...
        ("5", "Art. 63(9) CPR · KA/BK 2.4, 9.1",
         "Sehen die nationalen Förderfähigkeitsregeln oder die Aufrufe zur Einreichung von Vorschlägen eine klare Abgrenzung der Kostenkategorien vor?",
         ["Nationale Förderfähigkeitsregeln", "Aufrufe zur Einreichung von Vorschlägen"],
