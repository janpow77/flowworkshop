...
Seedet die KOM-Mustercheckliste "Annex 1.1 — Selection of operations (KR2)"
...
TITLE = "KOM — Auswahl der Vorhaben (KR2)"
...
PARTS = [
    ("Teil A — Festgelegte Auswahlmethodik, Kriterien und Förderfähigkeitsregeln (AC 2.1 und 2.2)", [
        ("1", "KR2 AC2.1 · Art. 40(2) und 73(1) CPR · Art. 22 Interreg-VO",
        ...
        ("2", "KR2 AC2.1 · Art. 73(1) CPR · Art. 22 Interreg-VO",
         ...
         ["Auswahlmethodik oder vergleichbares Dokument", "Veröffentlichte Aufrufe zur Einreichung von Vorschlägen"],
        ...
        ("5", "KR2 AC2.1 · Art. 73(1) CPR · Art. 22 Interreg-VO",
        ...
        ("6", "KR2 AC2.2 · Art. 63, 64, 67 und 68 CPR · Art. 37-44 und 56 Interreg-VO",
         "Sind die Förderfähigkeitsregeln für Ausgaben auf nationaler/regionaler Ebene festgelegt?",
         ["Bestehende nationale/regionale Rechtsvorschriften/Leitfäden", "Veröffentlichte Aufrufe"],
        ...
        ("7", "KR2 AC2.2 · Art. 63, 64, 67 und 68 CPR · Art. 37-44 und 56 Interreg-VO",
         "Sind klar definierte und eindeutige Förderfähigkeitsregeln für das Programm/den Projektaufruf festgelegt?",
         ["Veröffentlichte Aufrufe"],
        ...
        ("8", "KR3 AC3.2 · Art. 63, 64, 67, 68 und 73(1) CPR · Art. 22, 37-44, 56 Interreg-VO",
         "Entsprechen die in den veröffentlichten Aufrufen enthaltenen Kriterien (einschließlich Unterkriterien) und die Methodik den vom Begleitausschuss genehmigten?",
         ["Beschluss des Begleitausschusses", "Veröffentlichte Aufrufe"],
         "Die veröffentlichten Aufrufe müssen der vom Begleitausschuss genehmigten Methodik und den Kriterien folgen. Besonders auf Aufrufe achten, in denen Unterkriterien nicht in den genehmigten Dokumenten enthalten waren."),
        ("9", "KR2 AC2.2 · Art. 53 CPR",
         "Falls der Aufruf eine spezifische SCO-/FNLC-Methodik im Verhältnis VB-Begünstigte verwendet ('lower level' SCO): Entspricht diese einer von der EK genehmigten ('upper level' SCO)? Falls nicht, entspricht die Methodik den Anforderungen der Dachverordnung?",
         ["SCO-Methodik(en)"],
        ...
        ("10", "KR3 AC3.3 · Art. 49(1)-(2) CPR · Art. 36(1)-(2) Interreg-VO",
         "Werden die Förderfähigkeitsregeln den Begünstigten kommuniziert?",
         ["Veröffentlichte Aufrufe", "Website der VB/zwischengeschalteten Stelle oder dedizierte nationale Website"],
         "Prüfen, ob die Informationen zu den Aufrufen veröffentlicht und allen potenziellen Begünstigten zugänglich sind. Der Aufruf muss mindestens enthalten: klare Beschreibung des Auswahlverfahrens, vollständige Förderfähigkeitsregeln, Rechte und Pflichten der Begünstigten. Nicht anwendbar bei Direktzuweisung sowie bei Förderung nach Art. 29(1) und (3) CPR."),
    ]),
    ("Teil B — Auswahlprozess", [
        ("11", "KR2 AC2.3 · Art. 69(8), 73 und Anhang XVI §4 CPR · Art. 22 Interreg-VO",
        ...
        ("12", "KR2 AC2.3 · Art. 69(8), 73 und Anhang XVI §4 CPR",
         ...
         "Prüfen anhand von: Titel und Datum des Aufrufs; Einreichungsfrist; Datum und Form des Eingangs; bestätigende Stelle."),
        ("13", "KR2 AC2.3 · Art. 69(8), 73 und Anhang XVI §4 CPR",
         ...
         ["Verfahrenshandbücher", "Arbeitsunterlagen", "IT-System"],
         "Abgleich mit den Vorgaben des Aufrufs (z. B. Kapitel zur Rückgabe wegen Schreibfehlern oder fehlender Unterlagen)."),
        ("14", "KR2 AC2.4 · Art. 73 CPR · Art. 22 Interreg-VO",
         "Erfolgt die Bewertung auf Basis der zuvor vom Begleitausschuss genehmigten und im Aufruf veröffentlichten Auswahlkriterien — ohne andere Kriterien oder abweichende Gewichtungen/Bewertungen?",
         ["Bewertungsbögen", "Projektanträge", "Ausdrucke aus dem IT-System"],
         "Prüfen, ob das Auswahlverfahren auf den im Aufruf veröffentlichten Bestimmungen beruht."),
        ("15", "KR2 AC2.4 · Art. 73 CPR · Art. 22 Interreg-VO",
         ...
         ["Bewertungsbögen", "Projektanträge", "Ausdrucke aus dem IT-System"],
         "Prüfen, ob das Bewertungsverfahren für alle Anträge eines Aufrufs einheitlich angewandt wird (Gleichbehandlung)."),
        ("16", "KR2 AC2.4 · Art. 73(2)a CPR · Art. 22(4)a Interreg-VO",
        ...
        ("17", "KR2 AC2.4 · Art. 73(2)b CPR · Art. 22(4)b Interreg-VO",
        ...
        ("18", "KR2 AC2.4 · Art. 73(2)c CPR · Art. 22(4)c Interreg-VO",
        ...
        ("19", "KR2 AC2.4 · Art. 73(2)d CPR · Art. 22(4)d Interreg-VO",
        ...
        ("20", "KR2 AC2.4 · Art. 73(2)e CPR · Art. 22(4)e Interreg-VO",
         ...
         ["Bewertungsbögen", "Projektanträge", "Ausdrucke aus dem IT-System"],
         ""),
        ("21", "KR2 AC2.4 · Art. 73(2)f CPR · Art. 22(4)f Interreg-VO",
         ...
         ["Bewertungsbögen", "Projektanträge", "Ausdrucke aus dem IT-System"],
         ""),
        ("22", "KR2 AC2.4 · Art. 73(2)g CPR · Art. 22(4)g Interreg-VO",
         ...
         ["Bewertungsbögen", "Projektanträge", "Ausdrucke aus dem IT-System"],
         ""),
        ("23", "KR2 AC2.4 · Art. 73(2)h CPR · Art. 22(4)h Interreg-VO",
         ...
         ["Bewertungsbögen", "Projektanträge", "Ausdrucke aus dem IT-System"],
         ""),
        ("24", "KR2 AC2.4 · Art. 73(2)i CPR · Art. 22(4)i Interreg-VO",
         ...
         ["Bewertungsbögen", "Projektanträge", "Ausdrucke aus dem IT-System"],
         ""),
        ("25", "KR2 AC2.4 · Art. 73(2)j CPR · Art. 22(4)j Interreg-VO",
         "Stellt die VB/der Begleitausschuss die Klimaverträglichkeit von Infrastrukturinvestitionen mit einer erwarteten Lebensdauer von mindestens 5 Jahren sicher?",
         ["Bewertungsbögen", "Projektanträge", "Ausdrucke aus dem IT-System"],
         "Bei Interreg ist eine Bewertung der erwarteten Auswirkungen des Klimawandels durchzuführen."),
        ("26", "KR2 AC2.4 · Art. 64, 66 und 73(2) CPR · Art. 22(4) Interreg-VO",
        ...
        ("27", "KR2 AC2.5 · Art. 29(3)-(4), 33(3), 69(7) und 73(3) CPR · Art. 22, 28 und 36 Interreg-VO",
        ...
        ("29", "KR2 AC2.5 · Art. 69(7) CPR",
         ...
         ""),
        ("30", "KR2 AC2.5 · Art. 73(3) CPR · Art. 22(6) Interreg-VO",
         "Gibt es für die ausgewählten Projekte ein offizielles Dokument zwischen Programmbehörden und Begünstigten, das die Förderbedingungen festlegt?",
        ...
        ("31", "KR2 AC2.5 · Art. 73(1) CPR · Art. 22 Interreg-VO",
        ...
        ("33", "KR2 AC2.5 · Art. 118 und 118a CPR",
         "Erfüllt das Vorhaben bei phasenweise durchgeführten Projekten die Auswahlbedingungen?",
         ["Bewertungsbögen", "Projektanträge"],
         "Phasenweise durchgeführte Vorhaben müssen die in Art. 118 und 118a CPR genannten besonderen Anforderungen erfüllen, um förderfähig zu sein."),
    ]),
    ("Teil C — Querschnittsaspekte: Arbeitsabläufe, angemessener Prüfpfad, Doppelfinanzierung und Vermeidung von Interessenkonflikten", [
        ("34", "KR2 AC2.1-2.5 · Art. 69(11), 70, 71 und 72(1) CPR",
        ...
        ("35", "KR2 AC2.6 · Art. 69(6), Anhang XIII CPR",
        ...
        ("36", "KR7 AC7.4 · Art. 61 Haushaltsordnung · Art. 38 CPR · Art. 28 Interreg-VO",
    ...
    try:
        ...
        tpl = ChecklistTemplate(
            ...
            description=(
                ...
                "Vorhaben (Key Requirement 2), Förderperiode 2021-2027 — ins Deutsche "
            ...
            properties_json={
                ...
                "kom_reference": "EC audit checklists 2021-2027 — Annex 1.1 (KR2)",
            },
        )
        db.add(tpl)
