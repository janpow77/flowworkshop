...
PARTS = [
    ...
    ("Teil D — Verwaltungskontrolle von Vorhaben internationaler Organisationen (IO)", [
        ...
        ("4e", "Art. 22(5) AMIF / 18(5) BMVI / 17(5) ISF",
         "... dass, sofern der Zahlungsantrag Einheitskosten, Pauschalbeträge oder Pauschalfinanzierung betrifft, die Voraussetzungen für die Erstattung der Ausgaben erfüllt wurden?",
         [],
         ""),
